...
- dedup session refresh on Event::Visible transitions (#16)
...
[Unreleased]: https://github.com/timonwong/zellij-palette/compare/v0.2.2...HEAD
[0.2.2]: https://github.com/timonwong/zellij-palette/releases/tag/v0.2.2
